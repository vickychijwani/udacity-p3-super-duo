...
public class Utilies
{
    ...
    public static String getLeague(@NonNull Context context, int league_num)
    {
        switch (league_num)
        {
    ...
    public static String getMatchDay(@NonNull Context context, int match_day, int league_num)
    {
